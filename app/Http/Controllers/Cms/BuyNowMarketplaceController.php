...
class BuyNowMarketplaceController extends Controller
{
    protected string $slug = 'buy_now_marketplace';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cms.buy-now.index')->with('success', 'Marketplace berhasil ditambahkan.');
    }
}
